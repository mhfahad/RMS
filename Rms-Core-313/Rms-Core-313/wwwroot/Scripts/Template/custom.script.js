(function($) {
	...
	$(window).load(function() {		
        ...
        //    //$(".date-picker").datepicker({ dateFormat: "dd/mm/yy", timeFormat: "hh:mm:ss", maxDate: "0" });
		...
		/*----------  //PORTFOLIO GALLERY  ----------*/
        $(".date-picker-future").datepicker({ dateFormat: "dd/mm/yy", timeFormat: "hh:mm:ss" });

		$('.images-bg').each(function(){
			$(this).css({
                'background-image': 'url(' + $('.imasrc', this).hide().attr('src')+')'
			});
		});
    ...
    //$("#datetimepicker1").datepicker({ dateFormat: "dd/mm/yy", timeFormat: "hh:mm:ss", maxDate: "0" });
})(jQuery); 
...
//function getExpenseDetailsByExpenseId() {
//    var Vm = {
//        "Name": $("#name").val(),
//        "Phone": $("#phone").val(),
//        "Email" :$("#Email").val(),
//        "GuestAmount": $("#Guest").val(),
//		"Date": $("#DateTime").val(),
//        "Note": $("#Note").val(),
//	}
//	$("#Loader").show();
//    $.ajax({
//        type: "POST",
//        url: '/../../TableBooking/Create',
//        data: Vm,
//        success: function (data) {
//			if (data) {
//				$("#Loader").hide()
//                alert("Success! Please check your mail to comfirm your booking");
//            }
//			else {
//				$("#Loader").hide()
